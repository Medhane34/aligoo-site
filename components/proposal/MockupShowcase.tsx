...
export default function MockupShowcase({ data }: MockupShowcaseProps) {
  ...
  const description =
    data?.description ||
    "Building on the insights from the discovery and planning phase, we translate client needs into a high-converting landing page. This mockup demonstrates how we can transform your vision into a powerful lead generation tool.";
