...
export default function ComparisonTable({
  ...
  const [mobileViewPackage, setMobileViewPackage] =
    useState<PackageKey>(selectedPackage);
  ...
  return (
    <div ref={pricingTableRef} className="w-full max-w-7xl mx-auto my-20 px-4">
      {/* Mobile Dropdown */}
            ...
            <thead>
              <tr>
                ...
                {(["basic", "pro", "enterprise"] as PackageKey[]).map((pkg) => {
                  const isRecommended =
                    comparisonTable.recommendedPackage === pkg;
              ...
              <tbody key={group._key}>
                <tr>
                  <td
                    ...
                    colSpan={4}
                    style={{
                      backgroundColor: group.backgroundColor || "#1e293b",
                    }}
                  >
                    {group.groupTitle}
                  </td>
                ...
                {group.items.map((item, index) => (
                  ...
                  >
                    ...
                    {(["basic", "pro", "enterprise"] as PackageKey[]).map(
                      (pkg) => {
                        const isRecommended =
                          comparisonTable.recommendedPackage === pkg;
              ...
              <tr>
                ...
                {(["basic", "pro", "enterprise"] as PackageKey[]).map((pkg) => {
                  ...
                  return (
                    ...
                    >
                      <button
                        className={`w-full px-6 py-4 rounded-xl font-black text-white transition-all duration-300 transform ${
                          isSelected
