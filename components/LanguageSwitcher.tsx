        ...
        <div className="flex items-center justify-center mt-6">
            ...
            >
                ...
                <div className="flex-1 flex items-center justify-center z-10 text-xs font-semibold select-none gap-1">
                    <span className={`transition-colors duration-200 ${lang === 'en' ? 'text-white' : 'text-gray-500'}`}>
                        🇺🇸
                    </span>
                    <span className={`transition-colors duration-200 ${lang === 'en' ? 'text-white' : 'text-gray-500'}`}>
                        EN
                ...
                {/* Amharic Label */}
                <div className="flex-1 flex items-center justify-center z-10 text-xs font-semibold select-none gap-1">
                    <span className={`transition-colors duration-200 ${lang === 'am' ? 'text-white' : 'text-gray-500'}`}>
                        🇪🇹
                    </span>
                    <span className={`transition-colors duration-200 ${lang === 'am' ? 'text-white' : 'text-gray-500'}`}>
                        AM
