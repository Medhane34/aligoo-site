      ...
      <div className="container mx-auto px-4 text-text-light dark:text-text-dark">
        ...
        {activeTab === "problem" && (
          ...
          >
            ...
            >
              <motion.h2
                className={`text-4xl font-bold text-text-light dark:text-text-dark text-heading ${isAmharic ? "font-amharicHeading" : ""}`}
                variants={problemRightVariants}
              >
                {problemHeadline}
              </motion.h2>
              <motion.p
                className={`text-gray-600 dark:text-gray-400 text-body ${isAmharic ? "font-amharicBody text-lg" : ""}`}
                variants={problemRightVariants}
              >
                {problemText}
              </motion.p>
              <motion.div
                ...
                variants={problemRightContainerVariants}
              >
                {(Array.isArray(problemPoints) ? problemPoints : []).map(
                  (point, i) => (
        ...
        {activeTab === "ourWay" && (
          ...
          >
            ...
            >
              ...
              >
                <NextImage
                  ...
                  src={
                    imageOurWay1Url ||
                    "/page-content-images/about-us-ourway-1.png"
                  }
                  width={300}
                />
              </motion.div>
              ...
              >
                <NextImage
                  ...
                  src={
                    imageOurWay2Url ||
                    "/page-content-images/about-us-ourway-2.png"
                  }
                  width={300}
                />
              </motion.div>
            ...
            >
              {(Array.isArray(ourWayPoints) ? ourWayPoints : []).map(
                (point, index) => (
                  <motion.div
                    key={index}
                  ...
                  >
                    ...
                    <div>
                      <h3
                        className={`text-subheading font-bold text-text-light dark:text-text-dark mb-1 ${isAmharic ? "font-amharicHeading" : ""}`}
                      >
                        {point?.heading}
                      </h3>
                      <p
