...
export default function ToastAtom({
  type,
  title,
  message,
  onClose,
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute bottom-0 left-0 h-0.5 w-full bg-gradient-to-r from-transparent via-white/10 to-transparent opacity-50`}
      />
    </motion.div>
  );
}
