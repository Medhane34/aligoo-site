...
const card = tv({
  ...
  variants: {
    variant: {
      default:
        "bg-neutral-900/50 border border-white/10 backdrop-blur-sm hover:scale-[1.02]",
      spotlight: "bg-neutral-900/50 border border-white/10 backdrop-blur-sm",
      active:
        "bg-neutral-900/50 border-2 border-[#FF595E] shadow-2xl shadow-[#FF595E]/30 scale-[1.02]",
    },
    padding: {
      none: "p-0",
      sm: "p-4",
