import { fetchWhoThisIsForSection, WhoThisIsForSectionData } from "@/lib/services/funnelMapping";
import WhoThisIsForSection from "@/components/service-sections/WhoThisIsFor";

export default async function WhoFunnelWrapper({ lang = "en" }: { lang?: "en" | "am" }) {
    const data: WhoThisIsForSectionData | null = await fetchWhoThisIsForSection("whoThisIsForSection-FunnelMapping");
    if (!data) return null;
