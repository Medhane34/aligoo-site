import { fetchHeroSection, HeroSectionData } from "@/lib/services/funnelMapping";
import HeroSection from "@/components/HeroSection";

export default async function HeroFunnelWrapper({ lang = "en" }: { lang?: "en" | "am" }) {
    const data: HeroSectionData | null = await fetchHeroSection("heroSection-FunnelMapping");
    if (!data) return null;
    return (
        <HeroSection
