import { fetchFaqSection, FaqSectionData } from "@/lib/services/funnelMapping";
import FaqSection from "@/components/service-sections/FaqSection";

export default async function FaqFunnelWrapper({ lang = "en" }: { lang?: "en" | "am" }) {
    const data: FaqSectionData | null = await fetchFaqSection("faqSection-FunnelMapping");
    if (!data) return null;
