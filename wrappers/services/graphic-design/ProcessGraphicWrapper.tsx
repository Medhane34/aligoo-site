import { fetchOurProcessSection, OurProcessSectionData } from "@/lib/services/graphicDesign";
import ProcessSection from "@/components/service-sections/ProcessSection";

export default async function ProcessGraphicWrapper({ lang = "en" }: { lang?: "en" | "am" }) {
    const data: OurProcessSectionData | null = await fetchOurProcessSection("ourProcessSection-GraphicDesign");
    if (!data) return null;
