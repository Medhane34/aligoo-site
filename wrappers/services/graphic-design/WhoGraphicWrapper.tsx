import { fetchWhoThisIsForSection, WhoThisIsForSectionData } from "@/lib/services/graphicDesign";
import WhoThisIsForSection from "@/components/service-sections/WhoThisIsFor";

export default async function WhoGraphicWrapper({ lang = "en" }: { lang?: "en" | "am" }) {
    const data: WhoThisIsForSectionData | null = await fetchWhoThisIsForSection("whoThisIsForSection-GraphicDesign");
    if (!data) return null;
