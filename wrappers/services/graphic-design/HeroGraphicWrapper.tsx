import { fetchHeroSection, HeroSectionData } from "@/lib/services/graphicDesign";
import HeroSection from "@/components/HeroSection";

export default async function HeroGraphicWrapper({ lang = "en" }: { lang?: "en" | "am" }) {
    const data: HeroSectionData | null = await fetchHeroSection("heroSection-GraphicDesign");
    if (!data) return null;
    return (
        <HeroSection
