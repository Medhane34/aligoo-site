import { fetchOurProcessSection, OurProcessSectionData } from "@/lib/services/contentMarketing";
import OurProcess from "@/components/service-sections/ourprocess";

export default async function ProcessMarketingWrapper({ lang = "en" }: { lang?: "en" | "am" }) {
    const data: OurProcessSectionData | null = await fetchOurProcessSection("ourProcessSection-ContentMarketing");
    if (!data) return null;
