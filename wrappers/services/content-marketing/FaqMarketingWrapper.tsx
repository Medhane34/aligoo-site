import { fetchFaqSection, FaqSectionData } from "@/lib/services/contentMarketing";
import FaqSection from "@/components/service-sections/FaqSection";

export default async function FaqMarketingWrapper({ lang = "en" }: { lang?: "en" | "am" }) {
    const data: FaqSectionData | null = await fetchFaqSection("faqSection-ContentMarketing");
    if (!data) return null;
