import { fetchCTASection, CTASectionData } from "@/lib/services/contentMarketing";
import CTABottomSection from "@/components/CTA";

export default async function CtaMarketingWrapper({ lang = "en" }: { lang?: "en" | "am" }) {
    const data: CTASectionData | null = await fetchCTASection("ctaSection-ContentMarketing");
    if (!data) return null;
