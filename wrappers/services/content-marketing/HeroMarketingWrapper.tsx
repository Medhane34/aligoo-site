import { fetchHeroSection, HeroSectionData } from "@/lib/services/contentMarketing";
import HeroSection from "@/components/HeroSection";

export default async function HeroMarketingWrapper({ lang = "en" }: { lang?: "en" | "am" }) {
    const data: HeroSectionData | null = await fetchHeroSection("heroSection-ContentMarketing");
    if (!data) return null;
    return (
        <HeroSection
