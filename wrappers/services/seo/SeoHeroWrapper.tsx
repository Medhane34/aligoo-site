import { fetchHeroSection, HeroSectionData } from "@/lib/services/seo";
import HeroSection from "@/components/HeroSection";

export default async function SeoHeroSectionWrapper({ lang = "en" }: { lang?: "en" | "am" }) {
  const data: HeroSectionData | null = await fetchHeroSection("heroSection-Seo");
  if (!data) return null;
  return (
    <HeroSection
