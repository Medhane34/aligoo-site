import { fetchCTASection, CTASectionData } from "@/lib/services/webdesign";
import CTABottomSection from "@/components/CTA";

export default async function CTAWEBSectionWrapper({ lang = "en" }: { lang?: "en" | "am" }) {
  const data: CTASectionData | null = await fetchCTASection("ctaSection-webdesign");
  if (!data) return null;
  return (
    <CTABottomSection
