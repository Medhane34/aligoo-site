import { fetchHeroSection, HeroSectionData } from "@/lib/services/digitalmarketing";
import HeroSection from "@/components/HeroSection";

export default async function HeroDigitalSectionWrapper({ lang = "en" }: { lang?: "en" | "am" }) {
  const data: HeroSectionData | null = await fetchHeroSection("heroSection-Digital");
  if (!data) return null;
  return (
    <HeroSection
