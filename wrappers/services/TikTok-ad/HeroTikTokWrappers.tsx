import { fetchHeroSection, HeroSectionData } from "@/lib/services/tiktokad";
import HeroSection from "@/components/HeroSection";

export default async function HeroTikTokSectionWrapper({ lang = "en" }: { lang?: "en" | "am" }) {
  const data: HeroSectionData | null = await fetchHeroSection("heroSection-TikTok");
  if (!data) return null;
  return (
    <HeroSection
