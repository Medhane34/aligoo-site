...
const countriesData = [
    ...
    { code: "+1", name: "United States", flag: "🇺🇸", fullLabel: "United States (+1)" },
    { code: "+44", name: "United Kingdom", flag: "🇬🇧", fullLabel: "United Kingdom (+44)" },
...
const ContactForm = () => {
    ...
    const selectedCountryDisplayKey = React.useMemo(() => {
        ...
        const foundItem = countriesData.find(item => item.value === currentCountryCodeValue);
    ...
    const selectedServiceEnquiryKey = React.useMemo(() => {
        const foundItem = serviceEnquiryOptions.find(item => item.key === currentServiceEnquiryValue);
    ...
    const onSubmit = async (data: ContactFormInputs) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                reset({ // Clear the form and reset to default RHF values
                    fullName: "",
                    countryCode: "+251",
                    phoneNumber: "",
                    companyName: "",
            ...
            <div className="container mx-auto px-4">
                <div className="mb-12 text-center">
                    ...
                    <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                        Have questions or want to start a project? Reach out to us. We’re here to help!
                    </p>
                </div>
                ...
                <div className="flex flex-col md:flex-row gap-8 lg:gap-16">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <div className="relative flex items-center w-full">
                                <Select
                                    ...
                                    selectedKeys={selectedCountryDisplayKey ? [selectedCountryDisplayKey] : []} // Controlled by RHF value
                                    onSelectionChange={(keys) => {
                                        const selectedDisplayKey = Array.from(keys).at(0);
                                        if (selectedDisplayKey) {
                                            const selectedCountry = countriesData.find(item => item.displayKey === selectedDisplayKey);
                                            if (selectedCountry) {
                                                // Update react-hook-form's state with the actual code value
                                                setValue('countryCode', selectedCountry.value, { shouldValidate: true });
                                            }
                                        } else {
                                ...
                                >
                                    ...
                                    {(country) => ( // `country` here is an object from `countriesData`
                                        ...
                                        >
                                            {country.fullLabel} {/* Visible text in the dropdown list */}
                                        </SelectItem>
                                    )}
                                </Select>
                                <Input
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <Select
                                    ...
                                    selectedKeys={selectedServiceEnquiryKey ? [selectedServiceEnquiryKey] : []} // Controlled by RHF value
                                    onSelectionChange={(keys) => {
                    ...
                    <div className="md:w-1/2 p-8 bg-gray-50 dark:bg-gray-800 rounded-lg shadow-md md:bg-transparent md:shadow-none">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-8">
                            ...
                            taras tellus neul sarame tamat lae macorper del dierio denta low luco.
                        </p>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                            ...
                            <div className="flex items-center gap-4 p-4 bg-white dark:bg-gray-700 rounded-lg shadow-sm">
                                <span className="p-2 bg-gray-200 dark:bg-gray-600 rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 text-gray-600 dark:text-gray-200">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600 dark:text-gray-400">Jl. Raya Kuta No. 121</p>
                                </div>
                            </div>
                            {/* Mobile */}
                            <div className="flex items-center gap-4 p-4 bg-white dark:bg-gray-700 rounded-lg shadow-sm">
                                <span className="p-2 bg-gray-200 dark:bg-gray-600 rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 text-gray-600 dark:text-gray-200">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 0 0 6 3.75v16.5a2.25 2.25 0 0 0 2.25 2.25h7.5A2.25 2.25 0 0 0 18 20.25V3.75A2.25 2.25 0 0 0 15.75 1.5H13.5m-3 0V3.75m3-2.25V3.75M12 18.75h.008v.008H12v-.008Z" />
                                    </svg>
                                </span>
                                <div>
                                    <p className="font-semibold">Mobile</p>
                                    <p className="text-sm text-gray-600 dark:text-gray-400">(+021) 789 345</p>
                                </div>
                            </div>
                            {/* Availability */}
                            <div className="flex items-center gap-4 p-4 bg-white dark:bg-gray-700 rounded-lg shadow-sm">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600 dark:text-gray-400">Daily 09 am - 05 pm</p>
                                </div>
                            </div>
                            {/* Email */}
                            <div className="flex items-center gap-4 p-4 bg-white dark:bg-gray-700 rounded-lg shadow-sm">
                                <span className="p-2 bg-gray-200 dark:bg-gray-600 rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 text-gray-600 dark:text-gray-200">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 9v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.5H14.25m-1.5 0-.426.852M12 18.75h.008v.008H12v-.008Z" />
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21.75c0 1.242.41 2.373 1.1 3.294a.75.75 0 1 0 1.056-1.118c-.463-.585-.756-1.32-.756-2.176Z" />
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M6.25 12H4.5m-.75 0h-3m3 0H6.25m-2.25 0a9 9 0 1 1 18 0 9 9 0 0 1-18 0Z" />
                                    </svg>
                                </span>
                                <div>
                                    <p className="font-semibold">Email</p>
                                    <p className="text-sm text-gray-600 dark:text-gray-400">admin@support.com</p>
                                </div>
                            </div>
                        </div>
                        {/* Social Media (using placeholder icons) */}
                        <div className="mb-8">
                            <p className="font-semibold text-gray-600 dark:text-gray-300 mb-4">Social Media:</p>
                            <div className="flex gap-4">
                                {/* Facebook */}
                                <a href="#" aria-label="Facebook" className="text-gray-600 dark:text-gray-400 hover:text-blue-500 transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.27 0-5.192 1.583-5.192 4.615v3.385z"/></svg>
                                </a>
                                {/* Twitter/X */}
                                <a href="#" aria-label="Twitter" className="text-gray-600 dark:text-gray-400 hover:text-blue-400 transition-colors">
                                ...
                                {/* LinkedIn */}
                                <a href="#" aria-label="LinkedIn" className="text-gray-600 dark:text-gray-400 hover:text-blue-700 transition-colors">
                                ...
                                {/* Instagram */}
                                <a href="#" aria-label="Instagram" className="text-gray-600 dark:text-gray-400 hover:text-pink-500 transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.204-.012 3.584-.07 4.85-1.488 3.228-3.007 4.77-4.919 4.919-1.266.058-1.644.069-4.85.069-3.204 0-3.584-.012-4.85-.07-3.252-.148-4.771-1.691-4.919-4.919-.058-1.265-.069-1.645-.069-4.849 0-3.204.012-3.584.07-4.85 1.488-3.227 3.009-4.77 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.073 4.948.073 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zM12 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4s1.791-4 4-4 4 1.79 4 4-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>
                                </a>
                            </div>
                        </div>
                    </div>
