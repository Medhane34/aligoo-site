      ...
      <main className="container mx-auto flex flex-1 flex-col items-center justify-center overflow-hidden ">
        <section className="z-20 flex flex-col items-center justify-center gap-[18px] sm:gap-6">
          <Button
            ...
            endContent={
              <span className="pointer-events-none flex h-[22px] w-[22px] items-center justify-center rounded-full"></span>
            }
            radius="full"
            variant="bordered"
          >
         ...
         <div className="text-center text-[clamp(40px,10vw,44px)] font-bold leading-[0.8] tracking-tighter sm:text-[64px]">
          ...
          <div className="flex flex-row items-center justify-center gap-6 sm:flex-row">
            <Button className="w-[163px] h-10 px-[16px] py-[10px] text-small font-medium leading-5 bg-button-primary-light" radius="full">
              Get Started
            </Button>
            <Button
