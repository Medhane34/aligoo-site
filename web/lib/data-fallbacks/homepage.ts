...
export const FALLBACK_HERO = {
  ...
  subheading_am:
    "ብልህ የቢዝነሰ ዌብሳይቶችን እንገነባለን፣ ዉጤታማ ማስታወቂያ ካምፔኖችን ፣ እና ሰዎችን በእውነት ወደ እርምጃ የሚያነሳሳ ኮንቶንቶችን እናዘጋጃለን ።",
  subheading_en:
    "Aligoo is a full-service digital marketing agency based in Addis Ababa. We build smart websites, run killer ad campaigns, and craft content that actually gets people to act.",
};
  ...
  columns_en: [
      ...
      services: [
        {
          ...
          description:
            "Make the right moves, in the right channels, at the right time.",
          link: `en/services/digital-marketing`,
          iconUrl: null,
        },
        {
          title: "Content Strategy",
          description: "Build a brand story people actually care about.",
          link: `en/services/content-strategy`,
          iconUrl: null,
        },
        {
          title: "Funnel Mapping",
          description: "Design journeys that convert strangers into superfans.",
          link: `en/services/funnel-mapping`,
          iconUrl: null,
        },
      ],
    },
      ...
      services: [
        {
          title: "Web Design",
          description:
            "Beautiful, blazing-fast websites that work hard for your brand.",
        ...
        },
        {
          ...
          link: `en/services/graphic-design`,
          iconUrl: null,
        },
      ],
    },
    {
      ...
      services: [
        ...
        {
          title: "TikTok Ads",
          description: "Optimize customer journey.",
          link: `en/services/tiktok-ad`,
          iconUrl: null,
        },
      ],
    },
  ...
  columns_am: [
    {
      title: "ስትራቴጂ",
      description:
        "በብራንድህ፣ በታዳሚዎችህ፣ እና በገበያህ ውስጥ በጥልቀት እንገባለን — እያንዳንዱ እርምጃ በግንዛቤ የተደገፈ ይሆናል፣ በግምት አይደለም።",
      services: [
        {
          title: "ዲጂታል ግብይት ስትራቴጂ",
          description: "ትክክለኛውን እርምጃ በትክክለኛው ቻናል በትክክለኛው ጊዜ ያድርጉ።",
          link: `en/services/digital-marketing`,
          iconUrl: null,
        },
        {
          title: "የይዘት ስትራቴጂ",
          description: "ሰዎች በእውነት የሚጨነቁበት የብራንድ ታሪክ ይገንቡ።",
          link: `en/services/content-strategy`,
          iconUrl: null,
        },
        {
          title: "የፈንገል ካርታ",
          description: "እንግዳዎችን ወደ ሱፐርፋን የሚቀይሩ ጉዞዎችን ዲዛይን ያድርጉ።",
          link: `en/services/funnel-mapping`,
          iconUrl: null,
        },
      ],
    },
    {
      title: "ዲዛይን",
      description:
        "ነገሮችን ቆንጆ ለማድረግ ብቻ አይደለም — በዓላማ፣ በግላዊነት፣ እና በአፈጻጸም ዲዛይን እናደርጋለን።",
      services: [
        {
          title: "ድር ጣቢያ ዲዛይን",
          description: "ቆንጆ፣ በጣም ፈጣን ድር ጣቢያዎች ለብራንድህ በትጋት ይሰራሉ።",
          link: `en/services/digital-marketing`,
          iconUrl: null,
        },
        {
          title: "ግራፊክ ዲዛይን",
          description: "ፍላጎትን ወደ ክሊክ የሚቀይሩ ስክሮል-ማቆሚያ ቪዥዋሎች።",
          link: `en/services/digital-marketing`,
          iconUrl: null,
        },
      ],
    },
    {
      title: "ትግበራ",
      description:
        "ይህ ነው ጠንቋይው የሚሆነው። ከማስታወቂያ እስከ ትንታኔ፣ ስትራቴጅህን ወደ ሕይወት እናመጣለን — እና ውጤቶችን ለማሳደግ ቀጣይነት ያለው ማሻሻያ እናደርጋለን።",
      services: [
        {
          title: "ፌስቡክ እና ኢንስታግራም ማስታወቂያዎች",
          description: "ዘመናዊ፣ ምላሽ የሚሰጡ ድር ጣቢያዎች።",
          link: "/services/web-design",
          iconUrl: null,
        },
        {
          title: "SEO",
          description: "በጉግል ላይ ከፍ አድርግ።",
          link: "/services/seo",
          iconUrl: null,
        },
        {
          title: "ቲክቶክ ማስታወቂያዎች",
          description: "የደንበኛ ጉዞን አሻሽል።",
          link: "/services/tiktok-ad",
          iconUrl: null,
        },
      ],
    },
  ...
  steps_am: [
    {
      ...
      heading: "ጀምር",
      description:
        "የእውቂያ ፎርማችንን ሙላ — ስለ ንግድህ፣ ስለ ግቦችህ፣ ስለ ፈተናዎችህ፣ ስለ ተነሳሽ ህልሞችህ (ሁሉንም አይደለም… ገና) ንገረን። በተቻለህ መጠን ብዙ ትናገር፣ እኛም የተሻለ እንታደርግልሃለን።",
    },
    {
      icon: "📅",
      heading: "የጥሪ ቀጠሮ ይያዝ",
      description:
        "መረጃህን ካገኘን በኋላ፣ የግኝት ጥሪ ለማዘጋጀት እናነጋግርሃለን። እዚህ በትኩረት እንዳዘለን፣ ትክክለኛ ጥያቄዎችን እንጠይቃለን፣ እና የአንተን ቀጣይ ምርጥ እርምጃ እንመዘዝርልሃለን። ስትራቴጂ ሞድ፡ ተነሳ! 🚀",
    },
    {
      icon: "📄",
      heading: "ፕሮፖዛልህን ተቀበል",
      description:
        "እዚህ ኮፒ-ፔስት ቅናሾች የሉም። ብልህ ስትራቴጂዎች፣ ግልጽ ውጤቶች፣ ግልጽ ዋጋ፣ እና ተጨባጭ ጊዜ ያላቸው ለአንተ ብቻ የተዘጋጁ የጨዋታ እቅዶች ታገኛለህ። ምንም ተረት ተረት። ምንም ድንገተኛ ነገር።",
    },
    {
      icon: "🤝",
      heading: "አብረን እንገነባ",
      description:
        "አዎ ብለህ እንደተናገርክ፣ እኛ ወዲያውኑ እንንቀሳቀሳለን። ተከታታይ ዝማኔዎች፣ ለስላሳ ግንኙነት፣ እና በእውነት ውጤት የሚያመጡ ሥራዎች ትጠብቅ — ቆንጆ ሪፖርቶች ብቻ አይደለም።",
    },
  ],
  // Alias for projection
  steps: [
  ...
  reasons_am: [
    {
      ...
      title: "ለውሬዎቹ ተገንብተናል",
      description:
        "ትንንሽና መካከለኛ ንግዶችን መሥራት እንወዳለን — በተለይ ትላልቅ ኤጀንሲዎች የማያዩትን። በሆንክበት እንገናኝሃለን፣ በስትራቴጂ እንድታድግ እንረዳሃለን — በተረት ተረት አይደለም።",
      gradient: "from-blue-500 to-cyan-500",
      span: "col-span-1",
    },
    {
      emoji: "📊",
      title: "ውጤት ሁልጊዜ ቅድሚያ ነው",
      description:
        "በቃላት እንጣላቅ፣ ቆንጆ ሞክአፕ አናሳይም። የምናደርገው ሁሉ ከግልጽ ግቦች ጋር የተያያዘ ነው፡ ተጨማሪ ትራፊክ፣ ተጨማሪ መሪዎች፣ ተጨማሪ ሽያጮች። በእውነት የሚሰራ ፈጠራ።",
      gradient: "from-green-500 to-emerald-700",
      span: "col-span-1 row-span-2",
    },
    {
      emoji: "🌍",
      title: "ጥልቅ የአካባቢ ግንዛቤ",
      description:
        "በአዲስ የተመሠረተን እኛ የገበያህን ቋንቋ በቃልና በባህል እንናገራለን። የአካባቢ ደንበኛ የመግዛት አካሄድ ጥቃቅን ነገሮችን እንረዳለን፣ እና ወደ ዘመቻህና ዲዛይንህ እናስገባዋለን።",
      gradient: "from-orange-500 to-red-700",
      span: "col-span-1",
    },
    {
      ...
      title: "ነፍስ ያለው ዲዛይን",
      description:
        "እያንዳንዱ ፒክስል፣ ቃል፣ እና አቀማመጥ በዓላማ የተመረጠ ነው። ብራንድህ ቴምፕሌት ብቻ ሳይሆን እንደ አንተ የሚሰማውና ታዳሚዎችህን የሚያስደንቅ ድር ጣቢያና ስትራቴጂ ይገባዋል።",
      gradient: "from-purple-500 to-pink-500",
      span: "col-span-1",
    },
    {
      emoji: "📈",
      title: "ለእድገት የተዘጋጀ — ለመጀመር ብቻ አይደለም",
      description:
        "ቆንጆ ድር ጣቢያ የመጀመሪያው እርምጃ ብቻ ነው። እኛ ግብይትን አስቦ እንገነባለን — SEO፣ ፍጥነት፣ ፈንገል ዲዛይን፣ እና ተለዋዋጭነት — ድር ጣቢያህ ቆንጆ ብቻ ሳይሆን የሚሰራና የሚያድግ ይሆናል።",
      gradient: "from-teal-500 to-cyan-700",
      span: "col-span-1",
    },
    {
      emoji: "🤝",
      title: "ከአንተ ጋር ነን፣ ከላይ አይደለንም",
      description:
        "ምንም ኮርፖሬት እብሪት። ምንም ግራ የሚያጋባ ቋንቋ። እንደ እውነተኛ ሰዎች እንተባበራለን — በጋራ፣ በግልጽ፣ በፍጥነት ምላሽ ሰጪ። ፕሮጀክትህን እንደ የራሳችን እንመለከተዋለን።",
      gradient: "from-yellow-500 to-orange-700",
      span: "md:col-span-2 lg:col-span-2",
    },
  ],
...
export const FALLBACK_TESTIMONIALS = {
  ...
  testimonials_en: [
      ...
      body: [
        {
          ...
          children: [
            {
              text: "Aligo Marketing solution was the perfect partner for to help me grow my online business and I was very impressed with their service. They created a custom ads plan that suited my budget and goals, and helped me reach more customers across different platforms. They also provided me with detailed reports and insights on how to optimize my campaigns and increase my ROI. Aligo Marketing solution is a professional and reliable advertising company that I would highly recommend to anyone looking for online advertising solutions.!",
            },
          ],
        },
      ],
      ...
      body: [
        {
          ...
          children: [
            {
              text: "The web Developing company Aligoo and its founding partner Daniel has been very compassionate and timely in delivering their development. I also like to thank Daniel for his relentless effort of making time for this project and his unwavering commitment to his work. I had a pleasure working with them !!!",
            },
          ],
        },
      ],
      ...
      body: [
        {
          ...
          children: [
            {
              text: "Overall very pleased with Daniel and his friendliness with Me. He did everything I asked in a timely matter. I will definitely be recommending him to other companies. Thanks for such good work.",
            },
          ],
        },
      ],
    ...
    {
      name: "Ruta kesete",
      username: "Owner, Ruth KT hair",
      body: [
        {
          _key: "fb1",
          children: [
            {
              text: "Aligo Digital Betam new mamesegnew, tiru page nachu yserachulgn amesegnalew.",
            },
          ],
        },
      ],
    },
    {
      ...
      body: [
        { _key: "fb1", children: [{ text: "Well experienced web designer" }] },
      ],
    },
    {
      name: "Kaleb",
      username: "CEO, AdReady Tech Solutions",
      body: [
        {
          _key: "fb1",
          children: [
            {
              text: "Had a great experience getting our website redesigned . Would recommend to all",
            },
          ],
        },
      ],
      ...
      body: [
        {
          ...
          children: [
            {
              text: "Here i am for appreciation! Daniel or aligoo did i great job for Me. his best website designer , he did My website on time and on exact way what i ask him to have. Thank you dani Thank you Aligoo",
            },
          ],
        },
      ],
  ...
  testimonials_am: [
    {
      name: "ዮርዳኖስ ገ/ሥላሴ",
      username: "መስራች፣ ቃሲና ስዊትስ",
      body: [
        {
          _key: "fb1",
          children: [
            {
              text: "አሊጎ ማርኬቲንግ ለኦንላይን ንግዴ እንድበረታ ተስማሚ አጋር ነበር፣ አገልግሎታቸውም በጣም አስደነቀኝ። ለበጀቴና ለግቦቼ የሚስማማ ብጁ የማስታወቂያ እቅድ ፈጥረውልኝ፣ በተለያዩ መድረኮች ደንበኞችን እንድደርስ ረድተውኝ። ዘመቻዎቼን እንዴት ማሻሻልና ROI ማሳደግ እንደምችል በዝርዝር ሪፖርቶችና ግንዛቤዎች አቅርበውልኝ። አሊጎ ማርኬቲንግ ፕሮፌሽናልና ታማኝ የማስታወቂያ ኩባንያ ነው፣ ኦንላይን ማስታወቂያ ለሚፈልግ ሁሉ በልበ ሙሉነት እመክራለሁ!",
            },
          ],
        },
      ],
    ...
    {
      name: "አበሶሎሜ ባንጃው",
      username: "ባለቤት፣ አበርሆት ኢንተርየር ዲዛይን",
      body: [
        {
          _key: "fb1",
          children: [
            {
              text: "አሊጎ ማርኬቲንግ ለአርክቴክቸር ንግዴ እንድበረታ በጣም ጥሩ መፍትሄና አጋር ነበር፣ አገልግሎታቸውም በጣም አስደነቀኝ። ለበጀቴና ለእቅዴ የተበጁ ማስታወቂያዎች አዘጋጅተውልኝ፣ በኢትዮጵያ ውስጥ ያሉትን ተመልካቾች እንድደርስ ረድተውኝ። የብራንድ ግንዛቤና የደንበኛ ተሳትፎ በከፍተኛ ደረጃ ጨመረ፣ በመጨረሻም ጥራት ያላቸውን መሪዎች አመጣና በኢንቨስትመንቴ 3x ተመላሽ አስገኝቷል። ኩባንዬን /አበርሆት ዲዛይንስ/ እንዲያድግ ስላደረጉ በጣም ደስ ብሎኛል፣ ከልብ አመሰግናለሁ። እናመሰግናለን አሊጎ!",
            },
          ],
        },
      ],
    ...
    {
      name: "ዘላለም ሲማ",
      username: "ሲኢኦ፣ ዘላለም የህግ ጽ/ቤት",
      body: [
        {
          _key: "fb1",
          children: [
            {
              text: "የድር ጣቢያ ልማት ኩባንያ አሊጎ እና መስራች አጋሩ ዳንኤል በልማታቸው በተግባር በጣም ተግባብተውና በሰዓቱ አቅርበዋል። ዳንኤል ለዚህ ፕሮጀክት ጊዜ በማግኘትና ለሥራው ባሳየው የማያወላውል ቁርጠኝነት እናመሰግናለን። ከእነሱ ጋር መሥራት በጣም ደስ አሰኝ!!!",
            },
          ],
        },
      ],
    ...
    {
      name: "ተንበት እርምያስ",
      username: "የግብይት ሥራ አስኪያጅ፣ ቻሪቲ ፋውንዴሽን",
      body: [
        {
          _key: "fb1",
          children: [
            {
              text: "በአጠቃላይ ከዳንኤልና ከተግባብነቱ በጣም ረክቻለሁ። የጠየቅኩትን ሁሉ በሰዓቱ አድርጎልኛል። በተቻለኝ ሌሎች ኩባንያዎችን እመክራለሁ። ለጥሩው ሥራ እናመሰግናለን!",
            },
          ],
        },
      ],
    ...
    {
      name: "ሩታ ከሴተ",
      username: "ባለቤት፣ ሩት ኬቲ ፀጉር",
      body: [
        {
          _key: "fb1",
          children: [{ text: "አሊጎ ዲጂታል በጣም አመሰግናለሁ፣ ቆንጆ ገፅ አድርገ�, አመሰግናለሁ።" }],
        },
      ],
    },
    {
      name: "ኤፍሬም ሂሩት ኤክስፖርት",
      username: "ሲኢኦ፣ ሂርቱ ኤክስፖርት",
      body: [
        { _key: "fb1", children: [{ text: "በጣም ልምድ ያለው የድር ጣቢያ ዲዛይነር" }] },
      ],
    },
    {
      name: "ካሌብ",
      username: "ሲኢኦ፣ አድሬዲ ቴክ ሶሉሽንስ",
      body: [
        {
          _key: "fb1",
          children: [
            { text: "ድር ጣቢያችንን እንደገና ለመንደፍ በጣም ጥሩ ልምድ ነበረን። ለሁሉም እመክራለሁ" },
          ],
        },
      ],
    },
    {
      name: "ሴይድ ሙና",
      username: "መስራች፣ ሴያ ኢትዮጵያ ቱርስ",
      body: [
        {
          _key: "fb1",
          children: [
            {
              text: "እዚህ ለማመስገን መጣሁ! ዳንኤል ወይም አሊጎ ለእኔ በጣም ጥሩ ሥራ ሠርተዋል። ምርጥ የድር ጣቢያ ዲዛይነር ነው፣ ድር ጣቢያዬን በሰዓቱና በትክክለኛው መንገድ እንደፈለግኩት አድርጎልኛል። እናመሰግናለን ዳኒ፣ እናመሰግናለን አሊጎ!",
            },
          ],
        },
      ],
  ...
  casestudyPosts: [
    {
      ...
      goalsSummary:
        "Increase online sales and improve customer engagement through strategic digital marketing.",
      challengeSummary:
        "Low conversion rates and minimal social media presence were limiting growth potential.",
    ...
    },
    {
      ...
      goalsSummary:
        "Create a fast, beautiful, and conversion-optimized website for a growing startup.",
      challengeSummary:
        "Outdated website with poor mobile experience and slow loading times.",
    ...
    },
    {
      ...
      goalsSummary:
        "Drive brand awareness and engagement through targeted social media advertising.",
      challengeSummary:
        "Limited reach and engagement on social platforms despite quality content.",
    ...
    },
    {
      ...
      goalsSummary:
        "Improve search engine rankings and organic traffic for competitive keywords.",
      challengeSummary:
        "Poor search visibility and low organic traffic despite valuable content.",
    ...
    },
    {
      ...
      goalsSummary:
        "Establish thought leadership and drive qualified leads through strategic content.",
      challengeSummary:
        "Lack of consistent content strategy and minimal audience engagement.",
