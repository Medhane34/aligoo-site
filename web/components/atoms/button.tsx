...
export const GlowOutlineButton: React.FC<OutlineButtonProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute inset-x-0 -top-px mx-auto h-px w-3/4 bg-gradient-to-r from-transparent via-[#FF595E]/40 to-transparent`}
      />

      {/* Bottom Glow Divider: Uses hardcoded hex for guaranteed Tailwind class generation */}
      <div
        className={`absolute inset-x-0 -bottom-px mx-auto h-px w-3/4 bg-gradient-to-r from-transparent via-[#FF595E]/40 to-transparent`}
      />
