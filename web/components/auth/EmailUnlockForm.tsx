          ...
          >
            ...
            >
              ...
              {[
                ...
                {
                  icon: Users,
                  text: "Dedicated Team Introduction",
                  color: "text-green-400",
                },
                {
                  icon: Gift,
                  text: "Exclusive Launch Bonuses",
            ...
            >
              <p className="text-neutral-300 italic text-sm mb-2">
                "Aligoo transformed our online presence. Their attention to
                detail and professionalism exceeded our expectations."
              </p>
              <p className="text-neutral-400 text-xs font-medium">
                — Sarah M., CEO at TechStart
              </p>
            </motion.div>
            ...
            >
              ...
              <span>
                Secure access protected by Clerk • Your information is encrypted
              </span>
            </motion.div>
          </motion.div>
                ...
                <SignIn
                  appearance={{
                    ...
                    elements: {
                      ...
                      dividerRow: "hidden",
                      formFieldLabel:
                        "text-white font-medium text-sm mb-2 text-center",
                      formFieldInput:
                      ...
                      identityPreviewEditButton:
                        "text-[#FF595E] hover:text-orange-500",
                      formResendCodeLink:
                        "text-[#FF595E] hover:text-orange-500 text-center",
                      otpCodeFieldInput:
                        "bg-white/10 border-white/20 text-white text-center",
                    },
                  }}
