...
export default function BonusGiftSection({
  ...
  return (
    <section
      ref={sectionRef}
      className="relative py-32 overflow-hidden bg-gradient-to-b from-neutral-950 to-neutral-900"
    >
      {/* Background Effects */}
      <div className="absolute top-1/4 right-0 w-[500px] h-[500px] bg-orange-500/10 blur-[120px] rounded-full animate-pulse" />
      <div
        className="absolute bottom-1/4 left-0 w-[400px] h-[400px] bg-yellow-500/10 blur-[100px] rounded-full animate-pulse"
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        >
          {[
            ...
            <div
              key={i}
              className={`text-center ${isUrgent ? "animate-pulse" : ""}`}
            >
              <div
                className={`w-24 h-24 rounded-2xl flex items-center justify-center font-mono text-4xl font-black transition-all duration-300
              ...
              <div className="text-sm text-neutral-400 mt-2 font-medium">
                {unit.label}
              </div>
            </div>
          ))}
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <motion.div
                animate={
                  isChestOpen ? { rotateX: -120, y: -40 } : { rotateX: 0, y: 0 }
                }
        ...
        >
          ...
          <p className="text-sm text-neutral-500 mt-4 italic">
            P.S. These gifts are only available for committed clients. Act fast
            to secure your VIP advantages!
          </p>
        </motion.div>
      </div>
    </section>
