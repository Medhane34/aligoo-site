...
const defaultServices: BeyondLaunchService[] = [
  {
    ...
    description:
      "We believe that a website is a living, evolving entity. Our phased enhancement approach allows for strategic upgrades and improvements based on performance data and changing user needs.",
  },
  {
    icon: Megaphone,
    title: "Search Engine Marketing & Social Media Advertising",
    description:
      "We can create and manage targeted Google Ads and Facebook Ads campaigns to reach your ideal audience and increase website traffic.",
  },
  {
    icon: TrendingUp,
    title: "Search Engine Optimization (SEO)",
    description:
      "We can optimize your website to rank higher in search results, driving organic traffic and qualified leads.",
  },
  {
    icon: Shield,
    title: "Website Maintenance & Security",
    description:
      "We offer ongoing website maintenance to ensure your website stays up-to-date, secure, and functioning smoothly.",
  },
];
...
export default function BeyondLaunch({
  ...
  return (
    <section className="relative py-32 overflow-hidden bg-neutral-950">
      ...
      <div
        className="absolute bottom-1/4 right-0 w-[500px] h-[500px] bg-purple-500/5 blur-[150px] rounded-full animate-pulse"
