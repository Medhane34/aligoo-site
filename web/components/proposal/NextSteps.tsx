...
export default function NextStepsSection({
  ...
  return (
    <section className="relative py-32 overflow-hidden bg-neutral-950">
      ...
      <div
        className="absolute bottom-1/4 right-0 w-[400px] h-[400px] bg-cyan-500/10 blur-[100px] rounded-full animate-pulse"
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="hidden md:grid grid-cols-4 gap-6 mb-20 relative">
          ...
          {processedSteps.map((step, index) => {
            const Icon =
              iconMap[step.number as keyof typeof iconMap] || Package;
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <Check className="w-5 h-5 text-green-400" /> Cancel anytime before
            kickoff
          </div>
          <div className="flex items-center gap-2">
            <Check className="w-5 h-5 text-green-400" /> 100% satisfaction
            guarantee
          </div>
        </motion.div>
        ...
        >
          <div className="flex flex-col items-center gap-4">
            ...
            <h3 className="text-2xl font-black text-white">
              Important: This Proposal Expires Soon
            </h3>
            ...
            <p className="text-neutral-400">
              Lock in your bonuses and secure your slot before it's gone!
            </p>
          </div>
        </motion.div>
      </div>
