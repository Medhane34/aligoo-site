...
export const table = tv({
  slots: {
    ...
    wrapper:
      "relative overflow-x-auto rounded-2xl bg-neutral-900/50 border border-white/10 backdrop-blur-sm",
...
export const pagination = tv({
  slots: {
    ...
    button:
      "px-4 py-2 rounded-lg border border-white/10 bg-neutral-800/50 hover:bg-white/5 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-white/90",
    activeButton:
      "bg-[#FF595E] border-[#FF595E] text-white hover:bg-[#FF595E]/90",
...
export const button = tv({
  ...
  variants: {
    variant: {
      ...
      ghost:
        "bg-transparent border border-white/10 text-white/90 hover:bg-white/5",
...
export const dropdown = tv({
  slots: {
    trigger:
      "px-4 py-2 rounded-lg bg-neutral-800/50 border border-white/10 text-white/90 hover:bg-white/5 transition-all inline-flex items-center gap-2",
