...
export default function ContractPage() {
  ...
  const handleSign = async () => {
    if (!sigCanvas.current?.isEmpty() && proposal) {
      ...
      try {
        ...
        alert(
          `Error: ${error.message || "Failed to sign contract. Please try again."}`,
        );
      } finally {
        setSigning(false);
      }
  ...
  if (!proposal?.contractTemplate)
    return (
      <div className="min-h-screen bg-red-900 text-white flex items-center justify-center text-3xl">
  ...
  const data = {
    ...
    depositAmount:
      ((proposal.currentSelection?.totalPrice || 0) *
        (proposal.currentSelection?.depositPercentage || 50)) /
      100,
      ...
      <div className="max-w-4xl mx-auto p-6 pt-12 relative z-10">
          ...
          <div className="p-8 md:p-16">
            ...
            <div className="font-serif space-y-12 text-lg leading-relaxed">
              {proposal.contractTemplate.sections.map((section, i) => (
                <div key={i}>
                  ...
                  <div className="text-neutral-700 space-y-4">
                    {replacePlaceholders(section.body, data)
                      .split("\n")
                      .map((line, idx) => (
                        <p
              ...
              <div className="bg-neutral-100 p-8 rounded-lg border border-neutral-200 break-inside-avoid">
                <h3 className="font-sans font-bold text-neutral-900 mb-6 text-center uppercase tracking-wider">
                  Payment Schedule
                </h3>
                <div className="grid md:grid-cols-2 gap-6 font-sans">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-neutral-900">
                      {data.totalPrice.toLocaleString()} ETB
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-neutral-500 uppercase tracking-wider">
                    ...
                    <p className="text-2xl font-bold text-cyan-700">
                      {data.depositAmount.toLocaleString()} ETB
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-16">
                  ...
                  {signed ? (
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex gap-3">
                        <button
                          className="px-4 py-2 text-sm text-neutral-500 hover:text-red-500 font-medium transition-colors"
                ...
                <div>
                  ...
                  <div className="relative border border-neutral-200 rounded-lg p-6 bg-white">
                    {typeof proposal.contractTemplate.agencySignature
                      .signatureImage === "string" ? (
                      <img
                        alt="Agency Signature"
                        className="h-24 object-contain mb-2"
                        src={
                          proposal.contractTemplate.agencySignature
                            .signatureImage
                        }
                      />
                    ) : (
                    ...
                    <div className="border-t border-neutral-200 pt-2">
                      ...
                      <p className="text-sm text-neutral-500">
                        Authorized Signer, Aligoo Digital
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="mt-12 text-center pb-20">
          <p className="text-neutral-500 text-sm mb-4">
            Need to make changes? Contact your account manager.
          </p>
        </div>
      </div>
    </div>
