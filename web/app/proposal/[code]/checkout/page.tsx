...
export default async function CheckoutPage({
  ...
  if (!proposal?.currentSelection?.totalPrice) {
    return (
      <div className="text-white text-6xl text-center pt-40">ACCESS DENIED</div>
    );
  }
  ...
  const banks = [
    {
      name: "CBE",
      accountName: "Aligoo Digital PLC",
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-10 text-center md:text-left">
          ...
          <p className="text-neutral-400">
            Complete your secure payment to initialize the project.
          </p>
        </div>
          ...
          <div className="lg:col-span-5">
            <div className="sticky top-8">
              ...
              <p className="text-center text-neutral-500 text-xs mt-6 max-w-xs mx-auto">
                Your payment is secure. Once proof is uploaded, our team will
                verify and initialize your project dashboard within 1 hour.
              </p>
            </div>
          </div>
        </div>
