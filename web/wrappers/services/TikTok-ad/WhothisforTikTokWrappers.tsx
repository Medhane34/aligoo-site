import {
  fetchWhoThisIsForSectionTikTok,
  WhoThisIsForSectionDataTikTok,
...
export default async function WhoThisIsForTikTokWrapper({
  ...
  const data: WhoThisIsForSectionDataTikTok | null =
    await fetchWhoThisIsForSectionTikTok("whoThisIsForSection-TikTok");
